  ...
  <div class="home">
    <div class="hero is-info is-medium">
      <div class="hero-body has-text-centered">
        ...
        <h2 class="subtitle">Online place where you can learn what you want</h2>
        ...
        <div class="columns is-multiline">
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <p>This is just randon placeholder place</p>
            </div>
          </div>
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              <span class="icon is-size-2 has-text-info"><i class="far fa-home"></i></span>
